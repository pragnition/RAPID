...
**Plans**: 5 plans (Wave 1: review library+tests || agent roles+assembler, Wave 2: CLI+lean review, Wave 3: review SKILL.md+verification, Gap closure: speculative key_link cleanup)
...
- [ ] 22-05-PLAN.md -- Gap closure: remove speculative state-machine key_link from plan and review.cjs comment (REVW-01, REVW-04, REVW-07, REVW-08) [Wave 1, gap closure, depends: 22-01]
...
Plans:
- [x] 24-01-PLAN.md -- DOCS.md rewrite: introduction, installation, quick start, 17 command reference, workflow lifecycle, key concepts (DOCS-01) [Wave 1]
