...
- [x] **CMD-09**: /quick for ad-hoc changes without set structure
- [x] **CMD-10**: /add-set adds sets to an existing project mid-milestone
...
| CMD-09 | Phase 44 | Complete |
| CMD-10 | Phase 44 | Complete |
