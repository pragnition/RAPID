...
|---------|------|------|-------------|-----------|-------------------|-------------|--------|
| 44-01-01 | 01 | 1 | EXEC-01 | unit | `node --test src/lib/display.test.cjs` | ✅ | ⬜ pending |
| 44-01-02 | 01 | 1 | CMD-05 | manual-only | SKILL.md review | n/a | ⬜ pending |
| 44-01-03 | 01 | 1 | EXEC-02 | manual-only | SKILL.md review | n/a | ⬜ pending |
| 44-01-04 | 01 | 1 | EXEC-03 | manual-only | SKILL.md review | n/a | ⬜ pending |
| 44-02-01 | 02 | 1 | CMD-09 | manual-only | SKILL.md review | n/a | ⬜ pending |
| 44-03-01 | 03 | 1 | CMD-10 | manual-only | SKILL.md review | n/a | ⬜ pending |
| 44-04-01 | 04 | 1 | CMD-11 | manual-only | SKILL.md review | n/a | ⬜ pending |
...
|----------|-------------|------------|-------------------|
| execute-set SKILL.md valid frontmatter | CMD-05 | SKILL.md authoring, not executable code | Read SKILL.md, verify YAML frontmatter parses correctly |
| quick SKILL.md exists and is valid | CMD-09 | SKILL.md authoring | Read SKILL.md, verify structure matches skill pattern |
