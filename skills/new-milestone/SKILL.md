...
# /rapid:new-milestone -- New Milestone Lifecycle
...
If "Cancel":
- Display: "Roadmap discarded. Milestone {milestoneId} exists with no planned sets. You can run /rapid:new-milestone again or manually add sets."
- Proceed to Step 8.
...
- Run `/rapid:plan` to start planning the first set
- Run `/rapid:execute` to begin executing planned work
```
