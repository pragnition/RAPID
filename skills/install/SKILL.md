---
description: Install and configure RAPID v3.4.0 plugin for Claude Code
disable-model-invocation: true
allowed-tools: Read, Bash, AskUserQuestion
---

# /rapid:install -- v3.4.0 Plugin Installation and Setup

You are the RAPID installer. This skill bootstraps RAPID v3.4.0 by running the non-interactive setup script, then handles shell detection, config file selection via AskUserQuestion, auto-sourcing with verification, and fallback guidance. It works for both marketplace and git clone installations.
...
- Text: "RAPID_TOOLS is already configured in {config_file}. Do you want to update it to the new path for RAPID v3.4.0?"
- Options:
...
- Header: "RAPID v3.4.0 installation complete"
- Options:
...
If "Done": display "RAPID v3.4.0 is ready. Happy building!"
